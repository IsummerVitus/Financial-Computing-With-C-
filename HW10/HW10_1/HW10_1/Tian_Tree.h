...
#ifndef HW10_1_Tian_Tree_h
#define HW10_1_Tian_Tree_h
#include <vector>
#include <math.h>
#include <algorithm>
#include "BS.h"
...
public:
    ...
    double pricing_RichardsonExtrapolation()
    {
        ...
        Tiantree CRR1(spot, strike, sigma, r, T, N);
        CRR1.build_Tree();
        CRR1.finalprice();
        
        
        Tiantree CRR2(spot, strike, sigma, r, T, N/2);
        CRR2.build_Tree();
        CRR2.finalprice();
        ...
        double k = 1.0408;
        double p = (pow(2, k)*CRR1.pricing() - CRR2.pricing()) / (pow(2, k) - 1);
